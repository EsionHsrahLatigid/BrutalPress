...
function(ehl_yup_add_artifact_target)
    set(options)
    set(one_value_args TARGET PRODUCT SLUG PROFILE OUTPUT_ROOT STANDALONE_TARGET VST3_TARGET AU_TARGET)
    ...
    set(stage_dependencies ${EHL_STANDALONE_TARGET} ${EHL_VST3_TARGET})
    set(expect_au OFF)
